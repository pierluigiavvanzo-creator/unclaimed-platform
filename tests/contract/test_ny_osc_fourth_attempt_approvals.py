...
LOCAL_APPROVAL = ROOT / "sources/evidence/ny_osc_owner_name_file_fourth_attempt_transient_local_approval.v1.json"
PII_SCHEMA = ROOT / "schemas/common/ny_osc_fourth_attempt_transient_pii_approval.schema.json"
PII_APPROVAL = ROOT / "sources/evidence/ny_osc_owner_name_file_fourth_attempt_transient_pii_approval.v1.json"
