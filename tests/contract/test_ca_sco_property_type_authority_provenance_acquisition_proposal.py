...
SCHEMA_PATH = ROOT / "schemas/common/property_type_authority_provenance_acquisition_proposal.schema.json"
PROPOSAL_PATH = ROOT / "sources/proposals/ca_sco_segment_500_plus.property_type_authority_provenance_acquisition.v1.json"
REVIEW_EVIDENCE_PATH = ROOT / "sources/evidence/ca_sco_segment_500_plus.property_type_code_shape_provenance_offline.review.v1.json"
SEMANTIC_PROPOSAL_PATH = ROOT / "sources/proposals/ca_sco_segment_500_plus.property_type_semantic_verification.v1.json"
...
EXPECTED_AUTHORITY_URL = "https://www.sco.ca.gov/Files-UPD/upd_naupa_II_codes_dormancy_periods.pdf"
...
def test_base_is_pinned_to_verified_offline_review() -> None:
    ...
    assert base["offline_review_decision"] == "NO_SEMANTIC_CHANGE_JUSTIFIED_FROM_RETAINED_PROVENANCE"
...
def test_exactly_one_preexisting_authority_target_is_used() -> None:
    ...
    assert semantic["authority_reference"]["sco_naupa_codes_ref"] == EXPECTED_AUTHORITY_URL
...
def test_archival_contract_requires_immutable_sha256_and_post_review() -> None:
    ...
    assert archive["raw_authority_document_persistence_required_if_later_approved"] is True
...
def test_schema_blocks_silent_authorization_or_scope_widening() -> None:
    ...
    enabled["network_boundary"]["authority_network_access_authorized_by_this_proposal"] = True
